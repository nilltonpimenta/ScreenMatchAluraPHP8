...
require __DIR__ . "/src/Calc/Marathon.php";

echo "Bem-vindo(a) ao Screen match!\n";

$filme = new Filme("Thor: Ragnarok", 2017, Genero::SuperHeroi, 180);
...
$calc = new MarathonCalc();
$calc->add($filme);
$calc->add($serie);
$duracao = $calc->duracao();

echo "Para maratonar é preciso de $duracao minutos";
